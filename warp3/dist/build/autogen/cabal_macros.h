...
/* package warp3-1.0.0.0 */
#define VERSION_warp3 "1.0.0.0"
#define MIN_VERSION_warp3(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "warp3-1.0.0.0"

#define CURRENT_PACKAGE_KEY "warp3-1.0.0.0"
